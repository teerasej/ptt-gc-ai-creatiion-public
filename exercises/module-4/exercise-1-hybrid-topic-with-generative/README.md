# แบบฝึกหัดที่ 1: สร้าง Dual-Domain Generative Topic ด้วย Create Generative Answer Node
...
- [Knowledge file: technical terms](../../../files/module-4/financial-report-technical-terms-knowledge.docx)
- [Knowledge file: distribution policy](../../../files/module-4/financial-report-distribution-policy-knowledge.docx)
...
3. คลิกเลือกอัปโหลดไฟล์จากโฟลเดอร์ `files/module-4/`
